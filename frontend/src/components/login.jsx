          ...
          <MDBCol md="6">
            ...
            >
              ...
              <a
                ...
                href="#!"
                style={{ marginLeft: "250px", marginBottom: "20px", fontFamily: "'Poppins', sans-serif"}}
              >
                Forgot password?
              </a>
              <MDBBtn
              ...
              <p
                ...
                style={{ color: "#393f81", fontFamily: "'Poppins', sans-serif" }}
              >
                Don't have an account?{" "}
                <a href="#!" style={{ color: "#393f81", fontFamily: "'Poppins', sans-serif"}}>
                  Register here
                </a>
              </p>
            </MDBCardBody>
